<div class="row">
	...
	<div class="col-md-9">
		...
		<h4 style="margin:0px;">Bahan : <?php echo (isset($_GET['nama_kategori']) && isset($_GET['id_kategori'])) ? $_GET['nama_kategori'] : '' ?></h4>
		<hr>
		<br>
		<div class="row">
			<div class="col-md-12">
				<a href="<?php echo app_base.'create_bahan' ?>">
				...
				<div class="btn-group pull-right">
				  ...
				  <ul class="dropdown-menu">
				  	...
				  	?>
				    <li><a href="<?php echo app_base.'index_bahan&id_kategori='.$value2['id_kategori_produk'] ?>&nama_kategori=<?php echo $value2['nama_kategori'] ?>"><?php echo $value2['nama_kategori'] ?></a></li>
				    <?php }} ?>
				  </ul>
				</div>
				<br><br>
				<table width="100%" border="1" class="data">
					...
					<tr>
						...
						<td width="130">
							<a href="<?php echo app_base.'edit_bahan&id_bahan='.$value['id_bahan'] ?>">
								<button style="border:none; background:none; color:#000">
									<i class="fa fa-edit" style="font-size:1.2em"></i>
								</button>
							</a>
							<a onclick="return confirm('Hapus data ini?')" href="<?php echo app_base.'delete_bahan&id_bahan='.$value['id_bahan'] ?>">
								<button style="border:none; background:none; color:#000">
